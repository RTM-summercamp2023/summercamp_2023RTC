...
/*!
 * @file  ManagerModuleTest.h
 * @brief ModuleDescription (test code)
 *
 */
// </rtc-template>

#ifndef MANAGERMODULE_TEST__H
#define MANAGERMODULE_TEST_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  ManagerModuleTest(RTC::Manager* manager);

  /*!
   * @brief destructor
   */
  ~ManagerModuleTest() override;
...
extern "C"
{
  DLL_EXPORT void ManagerModuleTestInit(RTC::Manager* manager);
};

#endif // MANAGERMODULE_TEST_H
